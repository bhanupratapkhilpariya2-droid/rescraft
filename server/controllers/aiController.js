...
if(!userContent){
 ...
 const response =    await ai.chat.completions.create({
    ...
    messages: [
        { role: "system", content: "You are an expert in resume writing . your task is  to enhance the professional summary of a resume . the summary should be 1-2 sentances also highlight key skills,experience and career objectives .make it compelling and ATS-friendly . and only return text no options or anytihing else." },
        {
            role: "user",
            content: userContent,
        },
...
//controller for uploding a resume to the database 
