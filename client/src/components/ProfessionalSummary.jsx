  ...
  return (
    <div className='space-y-4'>
      <div className='flex items-center justify-between'>
        <div>
          <h3 className='flex items-center gap-2 text-gray-900 text-lg font-semibold'>Professional Summary</h3>
      ...
      <div className='mt-6'>
        ...
        <p className='text-xs text-gray-500 max-w-[80%] mx-auto text-center'>
          Tip: Keep it concise (3-4 sentences) and focus on your best achievements.
        </p>
      </div>
    </div>
  )
