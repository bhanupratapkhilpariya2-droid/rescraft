  ...
  return (
    <div className='relative'>
        ...
        bg-gradient-to-br from-blue-50 to-blue-100
         ...
         {isOpen && (
<div className='absolute top-full w-80 p-3 mt-2 space-y-3 z-50 bg-white
rounded-md border border-gray-200 shadow-sm max-h-96 overflow-y-auto'>

    
{templates.map((template)=>{
   return <div key= {template.id} onClick={()=>{onChange(template.id);
setIsOpen(false)}}
