...
const  Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
             <div className="flex items-center gap-2 text-sm text-purple-600 bg-purple-400/10 
        ...
        description='Create a professional resume in minutes with intelligent AI-powered tools and features.'/>
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Get a real-time, side-by-side comparison of every change you make to your resume.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">AI Features</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Enhance your professional summary and job descriptions effortlessly with the power of AI.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Resume Templates</h3>
                                <p className="text-sm text-slate-600 max-w-xs">We offer four resume templates, allowing you to choose the one that best fits your comfort and needs.</p>
                            </div>
                        </div>
                    </div>
                </div>
