import { Briefcase, Plus, Sparkles,LoaderCircleIcon, Trash2 } from 'lucide-react'
...
try {
 const response = await api.post('/api/ai/enhance-job-desc',{userContent:prompt},{headers:{
  Authorization: token
}})
  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <div>
          <h3 className='flex items-center gap-2 text-gray-900 text-lg font-semibold'>Professional Experience</h3>
...
{data.length === 0?(<div className='text-center py-8 text-gray-500 '>
    <Briefcase  className='w-12 h-12 mx-auto mb-3 text-gray-300 '/>
    <p>No work experience added yet.</p>
<p className='text-sm'>Click "Add Experience " to get satrted.</p>
</div>):(
<div>
...
Job Description
    ...
    disabled:opacity-50'>
      {generatingIndex===index?(<LoaderCircleIcon className='animate-spin size-4'/>):
