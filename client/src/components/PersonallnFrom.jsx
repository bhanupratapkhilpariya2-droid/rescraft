...
const PersonallnFrom = ({data ,onChange ,removebackground, setremovebackground}) => {
...
focus:border-blue-500 outline-none transition-colors text-sm'  placeholder={`Enter Your ${field.label.toLowerCase()}`}
